                    ...
                    <div key={IdTrade} className="rounded-2 overflow-hidden p-2" style={{ backgroundColor: "#17212b" }}>
                      ...
                      {Trade.Status === "open" && (
                        <div className="mt-2">
                          ...
                          {Trade.Bids.length > 0 ? (
                            <>
                              <div className="text-primary h6 mt-3">Trade offers received ({Trade.Bids.length})</div>
                              <div className="d-flex flex-column gap-1 p-1">
                                {Trade.Bids.map((Bid: any) => (
                                  <div key={Bid.IdHash} className="card">
                            ...
                            <div className="text-warning h6 mt-3 mb-0">No trade offers received yet</div>
                          )}
                        </div>
                      )}
                      ...
                      {Trade.Status === "accepted" && (
                        <>
                          <div className="text-primary h6 mt-3">Trader</div>
